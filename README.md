# State-Claw-Research — Agentic-Law-OS (soft fork of OpenClaw)

> This repository is a **soft fork** of [openclaw/openclaw](https://github.com/openclaw/openclaw),
> bootstrapped on 2026-05-11. A legal-research layer (rules engine, schemas, skills,
> statutory-corpus ingestion, KB MCP server, plugin pack) is being authored on top per
> [`docs/legal/PRD-OPENCLAW-FORK.md`](docs/legal/PRD-OPENCLAW-FORK.md).
>
> Currently in **Phase 0 — spike & verify**. See [`NOTICE.md`](NOTICE.md) for the relationship
> to upstream. OpenClaw's original README continues below.
